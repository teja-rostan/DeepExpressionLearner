...
class NNLearner:
    ...
    def __init__(self, attribute_size, class_size, n_hidden_layers, n_hidden_neurons=30):
        ...
        if self.n_hidden_layers == 2:
            ...
            noise_py_x = nnet.model2(X, self.w_h, self.w_h2, self.w_o, 0., 0.)
            ...
            noise_py_x = nnet.model3(X, self.w_h, self.w_h2, self.w_h3, self.w_o, 0., 0.)
            ...
            noise_py_x = nnet.model4(X, self.w_h, self.w_h2, self.w_h3, self.w_h4, self.w_o, 0., 0.)
